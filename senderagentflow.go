...
type AgentFlow struct {
	...
	Steps       []FlowStep  `json:"steps" api:"required"`
	Trigger     FlowTrigger `json:"trigger" api:"required"`
...
type FlowStep struct {
	...
	Type FlowStepType `json:"type" api:"required"`
...
// Returns the unmodified JSON received from the API
func (r FlowStep) RawJSON() string { return r.JSON.raw }
func (r *FlowStep) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// ToParam converts this FlowStep to a FlowStepParam.
//
// Warning: the fields of the param type will not be present. ToParam should only
// be used at the last possible moment before sending a request. Test for this with
// FlowStepParam.Overrides()
func (r FlowStep) ToParam() FlowStepParam {
	return param.Override[FlowStepParam](json.RawMessage(r.RawJSON()))
}
...
const (
	FlowStepTypeMessage   FlowStepType = "message"
	FlowStepTypeCollect   FlowStepType = "collect"
	FlowStepTypeCondition FlowStepType = "condition"
	FlowStepTypeTool      FlowStepType = "tool"
	FlowStepTypeLlm       FlowStepType = "llm"
	FlowStepTypeTransfer  FlowStepType = "transfer"
)

// The properties ID, Config, Type are required.
type FlowStepParam struct {
	// Unique step identifier.
	ID string `json:"id" api:"required"`
	// Step configuration (varies by type).
	...
	//
	// Any of "message", "collect", "condition", "tool", "llm", "transfer".
	Type FlowStepType `json:"type,omitzero" api:"required"`
	// ID of the next step to execute.
	NextStepID param.Opt[string] `json:"nextStepId,omitzero"`
	paramObj
}

func (r FlowStepParam) MarshalJSON() (data []byte, err error) {
	type shadow FlowStepParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FlowStepParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// Returns the unmodified JSON received from the API
func (r FlowTrigger) RawJSON() string { return r.JSON.raw }
func (r *FlowTrigger) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// ToParam converts this FlowTrigger to a FlowTriggerParam.
//
// Warning: the fields of the param type will not be present. ToParam should only
// be used at the last possible moment before sending a request. Test for this with
// FlowTriggerParam.Overrides()
func (r FlowTrigger) ToParam() FlowTriggerParam {
...
const (
	...
	FlowTriggerTypeIntent  FlowTriggerType = "intent"
	FlowTriggerTypeAlways  FlowTriggerType = "always"
...
func (r FlowTriggerParam) MarshalJSON() (data []byte, err error) {
	type shadow FlowTriggerParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FlowTriggerParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type SenderAgentFlowNewParams struct {
	Name        string            `json:"name" api:"required"`
	Steps       []FlowStepParam   `json:"steps,omitzero" api:"required"`
	Trigger     FlowTriggerParam  `json:"trigger,omitzero" api:"required"`
...
type SenderAgentFlowUpdateParams struct {
	...
	Priority    param.Opt[int64]  `json:"priority,omitzero"`
	Steps       []FlowStepParam   `json:"steps,omitzero"`
	Trigger     FlowTriggerParam  `json:"trigger,omitzero"`
	paramObj
}
