...
func TestUserAgentHeader(t *testing.T) {
	...
	if userAgent != fmt.Sprintf("Zavudev/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Messages.Send(context.Background(), zavudev.MessageSendParams{
		To:   "+14155551234",
		Text: zavudev.String("Hello from Zavu!"),
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Messages.Send(cancelCtx, zavudev.MessageSendParams{
		To:   "+14155551234",
		Text: zavudev.String("Hello from Zavu!"),
	})
	if err == nil {
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Messages.Send(deadlineCtx, zavudev.MessageSendParams{
			To:   "+14155551234",
			Text: zavudev.String("Hello from Zavu!"),
		})
		if err == nil {
