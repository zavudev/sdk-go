...
func TestContactGet(t *testing.T) {
	...
	_, err := client.Contacts.Get(context.TODO(), "contactId")
	if err != nil {
...
func TestContactListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Contacts.List(context.TODO(), zavudev.ContactListParams{
...
func TestContactGetByPhone(t *testing.T) {
	...
	_, err := client.Contacts.GetByPhone(context.TODO(), "phoneNumber")
	if err != nil {
		var apierr *zavudev.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
