...
// interacting with the zavudev API. You should not instantiate this client
...
// environment (ZAVUDEV_API_KEY, ZAVUDEV_BASE_URL). The option passed in as
