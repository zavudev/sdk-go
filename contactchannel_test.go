...
func TestContactChannelUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Contacts.Channels.Update(
		...
		zavudev.ContactChannelUpdateParams{
			ContactID: "contactId",
			Label:     zavudev.String("label"),
			Metadata: map[string]string{
				"foo": "string",
			},
			Verified: zavudev.Bool(true),
		},
	)
	if err != nil {
...
func TestContactChannelAddWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestContactChannelRemove(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestContactChannelSetPrimary(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
