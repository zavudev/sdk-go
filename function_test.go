...
func TestFunctionNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Functions.New(context.TODO(), zavudev.FunctionNewParams{
		Name: "Order Bot",
		Slug: "order-bot",
...
func TestFunctionGet(t *testing.T) {
	...
	_, err := client.Functions.Get(context.TODO(), "functionId")
	if err != nil {
		var apierr *zavudev.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestFunctionDelete(t *testing.T) {
	...
	_, err := client.Functions.Delete(context.TODO(), "functionId")
	if err != nil {
		var apierr *zavudev.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestFunctionDeployWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestFunctionGetDeployment(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Functions.GetDeployment(context.TODO(), "deploymentId")
	if err != nil {
		var apierr *zavudev.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestFunctionListDeploymentsWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestFunctionListEventTypes(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Functions.ListEventTypes(context.TODO())
	if err != nil {
		var apierr *zavudev.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestFunctionRollbackDeployment(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestFunctionTailLogsWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Functions.TailLogs(
		...
		zavudev.FunctionTailLogsParams{
			EndTime:       zavudev.Int(0),
			FilterPattern: zavudev.String("filterPattern"),
			Limit:         zavudev.Int(1),
			NextToken:     zavudev.String("nextToken"),
			StartTime:     zavudev.Int(0),
		},
	)
	if err != nil {
		var apierr *zavudev.Error
